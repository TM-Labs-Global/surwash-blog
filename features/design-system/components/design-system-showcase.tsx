                ...
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-[var(--bg-primary)] rounded-lg flex items-center justify-center">
                            <Droplet className="w-6 h-6 text-[var(--text-inverse)]" />
                        </div>
                        <div>
                            <Text variant="xl" weight="bold" className="tracking-tight block" intent="primary">SURWASH Blog</Text>
                            <Text variant="xs" intent="info" className="opacity-80">Design System v1.0</Text>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
                        <Text variant="sm" intent="info" className="opacity-80">Last updated: June 2026</Text>
                    </div>
                </div>
            </header>
