    ...
    return (
        <div className="flex flex-col lg:flex-row gap-12 items-center mb-20">
            <div className="flex-1 space-y-6">
                <div className="inline-flex items-center gap-2 bg-[var(--color-primary-50)] text-[var(--color-primary-500)] px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
                ...
                <h1 className="text-5xl md:text-6xl font-extrabold leading-[1.1] tracking-tight text-gray-900 dark:text-white">
                    Next.js <span className="text-[var(--color-primary-500)]">Feature-Based</span> Template
                </h1>
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                    <button className="bg-[var(--color-action-primary)] text-[var(--text-inverse)] px-8 py-3 rounded-xl font-bold hover:opacity-90 transition-opacity cursor-pointer">
                        Get Started
                    </button>
                    <button className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-8 py-3 rounded-xl font-bold hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer">
                        Live Demo
                    </button>
                </div>
            </div>
                ...
                <div className="bg-[#1a1c21] rounded-xl border border-gray-700 shadow-2xl overflow-hidden font-mono text-sm leading-relaxed">
                    ...
                    <div className="p-6 text-gray-300">
                        ...
                        <div className="ml-6 relative space-y-1">
                            ...
                            <div className="flex items-center gap-2 text-[var(--color-primary-500)] mt-2">
                                <span className="material-symbols-outlined text-sm">
                                    folder
                                </span>
                                <span>dashboard/</span>
