                ...
                <div className="space-y-12 relative">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 relative z-10">
                        <div className="flex-none flex items-start justify-center">
                            <div className="size-10 bg-[var(--color-primary-500)] text-white rounded-full flex items-center justify-center font-bold">
                                1
                            </div>
                        </div>
                        <div className="space-y-3">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">
                                ...
                                requirements for a specific domain (e.g., &ldquo;Generate a user
                                settings dashboard&rdquo;) and let the AI output clean Tailwind-ready
                                code.
                            </p>
                            <div className="bg-[#f9fafb] dark:bg-gray-800 p-4 rounded-lg border border-dashed border-gray-300 dark:border-gray-600 mt-4">
                                <span className="text-xs font-mono text-[var(--color-primary-500)] uppercase font-bold">
                                    Recommended Prompt
                                </span>
                                <p className="text-sm italic text-gray-500 mt-2">
                                    &ldquo;Generate a responsive Next.js functional component for a
                    ...
                    <div className="flex flex-col md:flex-row gap-8 relative z-10">
                        <div className="flex-none flex items-start justify-center">
                            <div className="size-10 bg-[var(--color-primary-50)] text-[var(--color-primary-500)] rounded-full flex items-center justify-center font-bold">
                                2
                            </div>
                        </div>
                        <div className="space-y-3">
